            ...
            <li>
              ...
              <ul role='list' className='-mx-2 mt-2 space-y-1'>
                {sidebarOptions.map((option) => {
                  return (
                    <li key={option.id}>
                      <Link href={option.href} className='text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group 
                                                          flex gap-3 rounded-md p-2 text-sm leading-6 font-semibold'>
                        <span className='text-gray-400 border-gray-400 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 
            ...
            <li className='-mx-6 mt-auto flex items-center'>
                <div className='flex flex-1 items-center gap-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900'>
                  ...
                  <div className='flex flex-col '>
                    ...
                    <span aria-hidden='true' className='text-xs text-zinc-400 truncate w-36 tracking-wide'>{session.user.email}</span>
                  </div>
                </div>
